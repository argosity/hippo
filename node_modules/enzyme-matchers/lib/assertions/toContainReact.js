...
function toContainReact(enzymeWrapper, reactInstance) {
  ...
  return {
    pass: pass,
    message: 'Expected <' + (0, _name2.default)(enzymeWrapper) + '> to contain ' + wrappedInstance.html() + ' but it was not found.',
    negatedMessage: 'Expected <' + (0, _name2.default)(enzymeWrapper) + '> not to contain ' + wrappedInstance.html() + ' but it does.',
